...
class CloudConfig(object):
    ...
    def mqtt_interface(self, panel):
        mqtt_list = [
            ...
            'wx.TextCtrl({}, 806, "", pos=(170, {}+120))'.format(panel, vertical_start_pos),
            ...
            'wx.TextCtrl({}, 807, "", pos=(170, {}+150))'.format(panel, vertical_start_pos),
            ...
            'wx.ComboBox({}, 808, choices=["0", "1"], style=wx.CB_READONLY, pos=(170, {}+180))'.format(panel, vertical_start_pos),
            ...
            'wx.ComboBox({}, 809, choices=["0", "1", "2"], style=wx.CB_READONLY, pos=(170, {}+210))'.format(panel, vertical_start_pos),
            ...
            'wx.TextCtrl({}, 810, "", pos=(170, {}+240), size=wx.Size(320, -1))'.format(panel, vertical_start_pos),
