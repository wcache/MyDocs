...
![](../DTU代码&文档/solution-DTU(公版)/images/qpycom_add_file.png)
...
![](../DTU代码&文档/solution-DTU(公版)/images/qpycom_run.png)
...
![](../DTU代码&文档/solution-DTU(公版)/images/dtu_init.png)
...
> CloudObserver：观察者对象类，主要用于被动接收通知。
>
> 主要有以下方法：
>
